...
frametime=1/fps;
Omitpre = 3; % We omit  figures before the stim onset due to stim artifact that might be there
Omitpost = fix(StimLength*1e-3/frametime)+2;% number of frames to omit after stim. not including stim that is also omitted.
